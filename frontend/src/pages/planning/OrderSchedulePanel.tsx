    ...
    <>
      ...
      <div className="table-wrap">
        <table>
          <thead>
            <tr>
              <th>Sipariş</th><th>Müşteri</th><th>Stok</th><th className="num">Miktar</th><th>Termin</th>
          ...
          <tbody>
            ...
            {list.length === 0 && <tr><td colSpan={13} className="muted">{rows === null ? "Yükleniyor…" : "Gösterilecek sipariş yok."}</td></tr>}
          </tbody>
        </table>
      </div>
    </>
